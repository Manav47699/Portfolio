...
export default function BlogPost() {
  ...
  const blog = {
    number: 'BLOG #02',
    title: 'How to build your local chatbot with RAG',
    date: 'December 10, 2024',
    githubRepo: 'https://github.com/Manav47699/local_chatbot_ollama_langchain_RAG_FastAPI.git',
    content: [
      {
        type: 'step',
        number: '1',
        title: 'Install the required dependencies',
        code: `pip install pandas             # Used to load CSV datasets
...
pip install langchain-chroma   # for Vector database for RAG.`,
      ...
      },
      {
        type: 'step',
        number: '2',
        title: 'Install ollama models and load them as models. My models are as below:',
        code: `ollama pull qwen2.5:1.5b         # required in main.py
ollama pull mxbai-embed-large    # required in vector.py`,
        language: 'bash',
        note: 'Run this in terminal (Ctrl + Alt + T)'
      },
      {
        type: 'step',
        number: '3',
        title: 'Prepare your csv file and load it.'
      },
      {
        type: 'step',
        number: '4',
        title: 'Run the vector.py page to create vector embeddings for your csv document',
        note: 'If you already have a db, or are creating a new db with a new model, delete the previous one with this command:',
        code: `rm -rf YOURDATABASENAME
# eg: rm -rf chrome_langchain_db`,
      ...
      },
      {
        type: 'step',
        number: '5',
        title: 'Run main.py to run your chatbot'
      }
    ]
  };
                    ...
                    <div key={index} className="mb-10">
                      ...
                      {section.code && (
                        <div className="ml-16 mb-4">
                          {section.note && (
                            <div className="bg-amber-50 border-l-4 border-amber-400 rounded-r-lg p-4 shadow-sm mb-4">
